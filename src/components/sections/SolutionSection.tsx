  ...
  return (
    <section className="px-4 sm:px-6 py-12 md:py-24 bg-background">
      <div className="max-w-3xl mx-auto text-center">
        <ScrollReveal>
          <h2 className="font-heading text-xl sm:text-2xl md:text-4xl font-bold mb-3 sm:mb-4 text-foreground">
            A Solução Mais Simples Que Existe
          </h2>
          <p className="text-lg sm:text-xl text-primary font-semibold mb-8 sm:mb-12">(E Você Usa Hoje Mesmo)</p>
        </ScrollReveal>

        <ScrollReveal delay={0.15}>
          <div className="bg-card border-2 border-primary/20 rounded-2xl p-5 sm:p-8 md:p-12 shadow-lg">
            <h3 className="font-heading text-2xl sm:text-3xl md:text-5xl font-extrabold text-primary mb-4 sm:mb-6">
            ...
            <div className="space-y-3 sm:space-y-4 text-base sm:text-lg text-left max-w-md mx-auto">
