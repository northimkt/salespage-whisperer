  ...
  return (
    <section className="px-4 py-16 md:py-24 bg-muted/30">
      <div className="max-w-3xl mx-auto">
        <ScrollReveal>
          <div className="bg-card border-2 border-secondary/30 rounded-2xl p-8 md:p-10 text-center shadow-lg">
            ...
            <div className="text-left max-w-lg mx-auto space-y-4 text-lg mb-8">
              ...
              <p className="text-2xl font-bold text-secondary">Devolvo 100%.</p>
